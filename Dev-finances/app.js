const Modal = {
 ...
 const Storage ={
    ...
    get(){
        //o set(transactions) transformou o transactions em string -> o get transforma de volta em array

        return JSON.parse(localStorage.getItem("dev.finances:transactions")) || [];
    },

    set(transactions){
        // os parâmetros do método setItem são so tipo chave-valor (dev.finances:transactions é a chave, transactions é o valor). setItem só trabalha com string e queremos passar um array, por isso usar JSON.stringfy
...
const Form = {
    ...
    formatValues(){
        ...
        console.log(amount +"format values")
